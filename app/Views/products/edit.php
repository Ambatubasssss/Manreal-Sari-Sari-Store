                    ...
                    <form action="<?= base_url('products/update/' . $product['id']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="quantity" name="quantity" 
                                           min="0" value="<?= old('quantity', $product['quantity'] ?? 0) ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="min_stock" name="min_stock" 
                                           min="0" value="<?= old('min_stock', $product['min_stock'] ?? 5) ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="unit" name="unit" 
                                           value="<?= old('unit', $product['unit'] ?? 'pcs') ?>" placeholder="e.g., pcs, kg, liters">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="image" name="image" 
                                   accept="image/*">
                            <small class="form-text text-muted">Leave empty to keep current image. Supported formats: JPG, PNG, GIF. Max size: 2MB</small>
                        </div>
